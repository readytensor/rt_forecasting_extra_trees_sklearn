...
class Forecaster:
    """Extra Trees Timeseries Forecaster.

    This class provides a consistent interface that can be used with other
    Forecaster models.
    """
    MODEL_NAME = "Extra_Trees_Timeseries_Forecaster"
    ...
    def __init__(
        ...
        """
        Construct a new Extra Trees Forecaster.        
    ...
    def build_model(self) -> ExtraTreesRegressor:
        """Build a new Extra Trees regressor."""
    ...
    def save(self, model_dir_path: str) -> None:
        """Save the Extra Trees forecaster to disk.
    ...
    def load(cls, model_dir_path: str) -> "Forecaster":
        """Load the Extra Trees forecaster from disk.

        Args:
            model_dir_path (str): Dir path to the saved model.
        Returns:
            Forecaster: A new instance of the loaded Extra Trees forecaster.
        """
